...
from APOSTRUCT.Backend.isotropy.catalog import (
    _basis_text,
...
from APOSTRUCT.Backend.parameter_names import (
...
from APOSTRUCT.Backend.source.magnetic import data as magnetic_source_data
...
class InvariantService:
    ...
    # Domain presentation can request one static factor catalog dozens of times
    # (54 in the NiS2 coupled case). Hoisting the fetch would couple the
    # match_subspace/domain-option/presentation layers, so cache immutable rows here.
