"""Normalize CLI and JSON inputs for the Distortropy pipeline."""
...
def case_from_json(payload: Any, *, base: Path) -> DistortropyCase:
...
def load_case(path: Path) -> DistortropyCase:
