...
from distortropy.Backend.parent import parent_cell_tuple
from distortropy.Backend.reciprocal import catalog as reciprocal_catalog
from distortropy.Backend.reciprocal.k_points import normalize_k_params
from distortropy.Backend.reciprocal.irreps import select_irrep
from distortropy.Backend.isotropy.coupled import coupled_opd_rows
...
def select_embedding_direction(
    ...
    if directions_payload.get("schema") != "distortropy.cli.directions":
...
def select_order_parameter_direction(
    ...
    *,
    ...
    return {
        **reciprocal_state,
        "schema": "distortropy.opd_direction.v1",
        "selected": {
...
def _select_coupled_order_parameter(
    ...
    *,
    ...
    return {
        **reciprocal_state,
        "schema": "distortropy.opd_direction.multi.v1",
        "selected": {
            **reciprocal_state["selected"],
            "irrep": slots[0]["irrep"],
