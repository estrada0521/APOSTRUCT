...
from distortropy.Backend.isotropy.engine.source_data import SourceData as OpdSourceData
...
def _subduced_mode_specs(
    ...
    selected_heading_k_label = _k_label_from_irrep_label(selected_label)
