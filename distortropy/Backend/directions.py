...
from distortropy.Backend.isotropy.catalog import _magnetic_source_orderparam
from distortropy.Backend.invariants.authority import invariant_source
from distortropy.Backend.invariants.domains import (
...
from distortropy.Backend.reciprocal.catalog import k_coordinate_map_for_slot
from distortropy.Backend.settings import public_setting
...
def compatible_directions(
    ...
    *,
    ...
    return {
        "schema": "distortropy.cli.directions",
        "parent": {
            "number": parent,
